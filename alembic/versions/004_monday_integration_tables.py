"""Add Monday integration tables (connections + oauth states)

Revision ID: 004_monday_integration
Revises: 003_widen_username
...
revision: str = "004_monday_integration"
down_revision: Union[str, None] = "003_widen_username"
